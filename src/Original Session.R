...
install.packages(XML, xts, tis, gridExtra) # Need to read .zoo, to store time series, recession shading, and captions
install.packages(XML, xts) # Need to read .zoo, to store time series
...
junk <- as.xts(landdata_fhfa_national_2016q1.df)
library(XML)
library(xts)
library(tis)
library(ggplot2)
...
# It works!
# Now replace it:
landdata_fhfa_national_2016q1.df$OBS
